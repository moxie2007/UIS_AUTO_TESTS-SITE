...
if __name__ == '__main__':
	...
	for tt in range(5):
		...
		# логинимся в ЛК
		tools_test.login_toLK_by_admin(adm_login = configLK.get_user_name, adm_pass = configLK.get_pass, user_id = '11128', stend_url = configLK.get_login_url, timeOut = 120, breakONerror = False)
